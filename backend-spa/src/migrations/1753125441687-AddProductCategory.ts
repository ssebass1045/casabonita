...
export class AddProductCategory1753125441687 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."product_category_enum" AS ENUM('facial', 'corporal', 'cabello', 'tratamiento_especial', 'otros')`,
    );
    await queryRunner.query(
      `ALTER TABLE "product" ADD "category" "public"."product_category_enum" NOT NULL DEFAULT 'otros'`,
    );
  }
